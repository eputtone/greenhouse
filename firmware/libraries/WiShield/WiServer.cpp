...
void Server::init(pageServingFunction function) {
        ...
        Serial.println("WiServer init starting");


	// WiShield init
	zg_init();

        Serial.println("WiServer init 1");

#ifdef USE_DIG0_INTR
	attachInterrupt(0, zg_isr, LOW);
#endif

        Serial.println("WiServer init 2");
	...
	PCMSK0 |= (1<<PCINT0);
        ...
        Serial.println("WiServer init 3");
	...
	while(zg_get_conn_state() != 1) {
        ...
        Serial.println("WiServer init 4");
